...
class Db {
    ...
    class func getDb() -> FMDatabase {
        ...
        //let databasePath = docsDir.stringByAppendingPathComponent("community.db")
        let databasePath = NSURL(string: docsDir)?.URLByAppendingPathComponent("community.db").absoluteString
